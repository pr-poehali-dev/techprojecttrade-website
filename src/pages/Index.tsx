          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="space-y-6">
                <p className="text-lg">
                  ООО «ТехПроектТрейд» работает на рынке строительных материалов с 2010 года. За это
                  время мы заслужили доверие тысяч клиентов благодаря высокому качеству продукции и
