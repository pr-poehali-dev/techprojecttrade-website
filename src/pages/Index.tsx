          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
                <img
                  src="https://cdn.poehali.dev/projects/5cadee6b-97bd-43a3-8c0c-747b1d26ba82/files/10ae9dc2-4c5a-4f88-b672-47fa961b48c0.jpg"
                  alt="Складские помещения ТехПроектТрейд"
                  className="w-full h-full object-cover"
                />
              </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          666037, Россия, Иркутская обл., г. Шелехов,<br />
                          пр-кт Строителей и Монтажников, д. 11, корп. 2, помещ. 1
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li>г. Шелехов, пр-кт Строителей и Монтажников, 11-2</li>
              </ul>
            </div>
            <div>
